...
import nuxt_plugin_axios_47f411df from 'nuxt_plugin_axios_47f411df' // Source: ./axios.js (mode: 'all')
...
async function createApp (ssrContext) {
  ...
  const app = {
    head: {"title":"BlogGo Project || Erdal Yenigül","meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":"BlogGo: son haberler!"}],"link":[{"rel":"stylesheet","href":"https:\u002F\u002Ffonts.googleapis.com\u002Fcss2?family=Poppins:ital,wght@0,300;0,400;0,500;0,600;0,700;1,500;1,600;1,700&display=swap"}],"style":[],"script":[]},
  ...
  if (typeof nuxt_plugin_axios_47f411df === 'function') {
    await nuxt_plugin_axios_47f411df(app.context, inject)
  }
